# 14 — Choosing Between Prompting, RAG, and Fine-Tuning

Decision-framework topic — builds directly on Topics 06, 08, 13. No separate code progression; the deliverable is a written framework backed by your own eval numbers.

## Fresher

Understand the basic three-way tradeoff (cost/complexity/latency to implement vs quality/consistency gained).

## Intermediate

Build a decision framework:
- Does the model need new facts? → RAG
- Does it need new behavior/format/style? → fine-tuning
- Can better instructions solve it? → prompting first, always
